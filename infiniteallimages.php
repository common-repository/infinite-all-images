...
if ( ! class_exists( 'InfiniteAllImagesAdmin' ) ) {
	require_once __DIR__ . '/lib/class-infiniteallimagesadmin.php';
}
if ( ! class_exists( 'InfiniteAllImages' ) ) {
	require_once __DIR__ . '/lib/class-infiniteallimages.php';
}
